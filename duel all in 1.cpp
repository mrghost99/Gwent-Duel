        ...
        for(i=1;i<2*B;i++)
              {
                  ...
                  for(g=0;g<10;g++)
                  {
                        ...
                        hp1=a+g;
                        armor1=g;cond2=1;d3=D3;cond1=1;d4=D4;
                        // duel calc //
                        while(hp1>0 && hp2>0)
                            {
                                 c=c+1;
                ...
                int n;int o1,o2;
                printf("\n here's the best units to duel for value = %d, to %d (power,armor) :",INvalue,INvalue-(B%10)-(B/10));
                float x=(B%10)+(B/10)+1;
                printf("\n");
                for(n=0;n<x;n++)
                {
...
{
    // reading //
               int a,b,armor1,armor2,i,g,hp1,hp2,A,B,INvalue,INv,OUTvalue,OUTv,c,INar2,OUTar2;int AR1=0;int s=0; int j=0;int w=0;int d2=0;int d=1;int d3=0;int red=0;
                INvalue=0;
                INar2=0;
                OUTvalue=0;int str=5;
                c=0;
              ...
              hp1=a+armor1;A=a;AR1=armor1;i=0;
              ...
              for(i=1;i<2*d*A*5;i++)
              {
                ...
                int n;int o1,o2;
                printf("\n here's the best units to duel for value = %d, to %d (power,armor) :",INvalue,INvalue-(A%10)-(A/10));
                float x=(A%10)+(A/10)+1;
                printf("\n\n");
                for(n=0;n<x;n++)
                {
...
int main()
{
        ...
        while(y==1)
        {
            printf("calculate duel ( 1 ) or search for best value? ( 2 ) , exit = other, #= ");
            scanf("%d",&Q);
            L=Q;
            while(Q==1 || L==1)
                {
